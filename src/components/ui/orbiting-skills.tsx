...
// --- Type Definitions ---
type IconType = 'html' | 'css' | 'javascript' | 'react' | 'node' | 'tailwind' | 'python' | 'sql' | 'tableau';
...
const iconComponents: Record<IconType, { component: () => React.JSX.Element; color: string }> = {
  ...
  python: {
    component: () => <PythonIcon className="w-full h-full text-[#3776AB]" />,
    color: '#3776AB'
  },
  sql: {
    component: () => <DatabaseIcon className="w-full h-full text-[#336791]" />,
    color: '#336791'
  },
  tableau: {
    component: () => <TableauIcon className="w-full h-full text-[#E97627]" />,
    color: '#E97627'
  }
};
